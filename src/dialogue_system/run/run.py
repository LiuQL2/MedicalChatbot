...
parser.add_argument("--episodes", dest="episodes", type=int, default=500, help="the number of episodes.")
parser.add_argument("--epoch_size", dest="epoch_size", type=int, default=100, help="the size of each simulation.")
parser.add_argument("--evaluate_epoch_size", dest="evaluate_epoch_size", type=int, default=500, help="the size of each simulation when evaluation.")
...
parser.add_argument("--hidden_size_dqn", dest="hidden_size_dqn", type=int, default=20, help="the hidden_size of DQN.")
...
parser.add_argument("--agent_id", dest="agent_id", type=int, default=2, help="specify the agent to be used:{0:AgentRule, 1:AgentDQN, 2:AgentActorCritic}")
