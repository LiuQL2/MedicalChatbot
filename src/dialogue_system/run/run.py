...
parser.add_argument("--epoch_size", dest="epoch_size", type=int, default=48, help="the size of each simulate epoch.")
...
parser.add_argument("--warm_start_epoch_number", dest="warm_start_epoch_number", type=int, default=48, help="the number of epoch of warm starting.")
...
# TODO: agent to use.
parser.add_argument("--agent_id", dest="agent_id", type=int, default=2, help="the agent to be used:{0:AgentRule, 1:AgentDQN, 2:AgentActorCritic, 3:AgentRandom}")
...
if disease_number == 7:
    ...
    # for 4 diseases.
    max_turn = 22
    parser.add_argument("--action_set", dest="action_set", type=str, default='./../data/final_dataset/action_set.p',help='path and filename of the action set')
    parser.add_argument("--slot_set", dest="slot_set", type=str, default='./../data/final_dataset/slot_set.p',help='path and filename of the slots set')
    parser.add_argument("--goal_set", dest="goal_set", type=str, default='./../data/final_dataset/goal_set.p',help='path and filename of user goal')
    parser.add_argument("--disease_symptom", dest="disease_symptom", type=str,default="./../data/final_dataset/disease_symptom.p",help="path and filename of the disease_symptom file")
