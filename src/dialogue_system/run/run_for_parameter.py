...
def run(parameter, main_checkpoint_path):
    ...
    success_reward = parameter.get("reward_for_success")
...
learning_rate_list = [0.001, 0.0001, 0.01]
max_turn_list = [22, 44]
data_set_list = ["1","2","3"]
minus_left_slots_list = [1,0]

for data_set in data_set_list:
    data_set_path = "./../data/dataset/1200/" + data_set + "/"
    performance_path = "./../data/dataset/1200/" + data_set + "/result/learning_rate/"
    main_checkpoint_path = "./../data/dataset/1200/" + data_set + "/result/checkpoint/"
    log_dir = "./../data/dataset/1200/" + data_set + "/result/log/"
    for max_turn in max_turn_list:
        for minus_left_slots in minus_left_slots_list:
            for lr in learning_rate_list:
                ...
                parser.add_argument("--critic_learning_rate", dest="critic_learning_rate", type=float, default=0.001,
                ...
                # TODO: 4 diseases. goal set, slot set, action set, reward
                ...
                parser.add_argument("--minus_left_slots", dest="minus_left_slots", type=int, default=minus_left_slots,
